...
/* Drag and drop todos*/
    Sortable.create(document.getElementById('todoContainer'),{
        onEnd : function(evt) {
            var container = document.getElementById('todoContainer'); //old index
            var childs = document.querySelectorAll('.todo'); //dragged HTMLElement
            var orderedIds = [];
